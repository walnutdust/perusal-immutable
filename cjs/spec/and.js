...
function and(name) {
  (0, _tinyInvariant['default'])(
    typeof name === 'string',
    'perusal-immutable.and was called with an invalid name.'
  );
  ...
  (0, _tinyInvariant['default'])(
    specs.length > 0,
    'perusal-immutable.and was called without specs.'
  );
  ...
  for (var _i = 0, _specs = specs; _i < _specs.length; _i++) {
    ...
    (0, _tinyInvariant['default'])(
      ...
      'perusal-immutable.and was called with invalid specs.'
    );
  }
